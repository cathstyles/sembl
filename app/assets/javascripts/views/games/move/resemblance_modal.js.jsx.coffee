    ...
    `<div className="move__resemblance__edit">
      <form onSubmit={this.handleSubmit} className="move__resemblance__edit-form">
        ...
        <div className="move__resemblance__nodes">
          ...
          <input className="move__resemblance__description" ref="input" type="text" onChange={this.handleChange.bind(this, "description")} value={this.state.description} placeholder="Enter your resemblance" name="move__resemblance__description"/>
